-- ============================================================
-- Migration: ensure_sermon_series
-- Ensures the sermon_series table exists (idempotent re-apply)
-- Fixes the broken comment in the previous migration file.
-- ============================================================

-- sermon_series table (idempotent)
...
-- Extend sermons table (all additive / nullable)
ALTER TABLE sermons
...
-- Apply trigger to sermon_series (idempotent)
