...
import { Header } from "@/components/caci/header";
import { Hero } from "@/components/caci/hero";
import { SeriesGrid } from "@/components/caci/series-grid";
import { MinistrySection } from "@/components/caci/ministry-section";
import { Footer } from "@/components/caci/footer";
import { SeriesDetail } from "@/components/caci/series-detail";
import { SermonDetail } from "@/components/caci/sermon-detail";
...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      {/* Footer only on home view (detail views have their own scroll) */}
      <AnimatePresence>
        {view.name === "home" && (
          <motion.div
            initial={{ opacity: 0 }}
